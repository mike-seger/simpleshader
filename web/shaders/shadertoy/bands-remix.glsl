/*
    Source: https://www.shadertoy.com/view/NdG3WR
    The licanse if not specified by the author is assumed to be:
    ...
    (e.g. renaming mainImage to main, stubbing iChannel0, etc.). If you intend to reuse this shader, please add credits to 'DSwerer'.
*/
