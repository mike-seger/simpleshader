...
interesction distance. I am also scaling the noise tapsas a 
...
// WebGL 1 compatible hash (replaces uvec2/bitwise original)
vec2 nmzHash22(vec2 q)
{
    vec3 p3 = fract(vec3(q.xyx) * vec3(.1031, .1030, .0973));
