/*
    Source: https://www.shadertoy.com/view/WfVczz
    ...
    (e.g. renaming mainImage to main, stubbing iChannel0, etc.). If you intend to reuse this shader, please add credits to 'Pezzza'.
*/
...
// palette lookup (GLSL ES 1.00 can't use array constructors)
